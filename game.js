...
const images = ["car.svg", "cola.svg", "donut.svg", "beer.svg", "ice-cream.svg", "popcorn.svg"];

let cardHTML = "";

images.forEach((img) => {
	cardHTML += `<div class="memorycard" data-card="${img}"> <img class="frontface" src="img/${img}"> <img class="backface" src="img/js-badge.svg"> </div>`;
});
